...
const SealedBidV1RevealAction = ({ callback, data }) => {
  ...
  const isLoading = isConfirming || isPending || internalLoading;
...
export default SealedBidV1RevealAction;