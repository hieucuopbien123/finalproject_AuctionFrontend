...
const VickreyCardClaimDialog = ({ claimDialogIsOpen, openClaimDialog, data }) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <VickreyClaimAction data={data} callback={() => openClaimDialog(false)}/>
      </DialogContent>
    </Dialog>
  )
}

export default VickreyCardClaimDialog;